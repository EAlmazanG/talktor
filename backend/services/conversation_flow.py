...
class ConversationFlow:
    ...
    async def end_conversation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Check if feedback is already available from RealtimeAgent
            feedback_data = None
            if hasattr(self.realtime_agent, 'last_feedback') and self.realtime_agent.last_feedback:
                feedback_data = self.realtime_agent.last_feedback
                logger.info("✅ Using feedback already generated by RealtimeAgent")
