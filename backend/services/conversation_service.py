    ...
    async def handle_function_call(
        ...
        try:
            ...
            if name == "continue_conversation":
                ...
                logger.info(f"📥 Received structured feedback: {json.dumps(function_call_args, indent=2)[:800]}...")
                ...
                for pillar in pillars:
                    ...
                    logger.info(f"📈 {pillar.capitalize()}: {score}/10.0")
                ...
                if hasattr(session_state, "agent") and session_state.agent:
                    try:
                        ...
                        # Persistence is handled during finalization in the WebSocket flow.
                        # Avoid saving here to prevent duplicate feedback insertion.
                        logger.debug("Deferring feedback persistence to finalize step to avoid duplicates")
